...
class Scene {
  ...
  addLights() {
    //this.scene.add(new THREE.AmbientLight(0xffffe6, 1.0));
  }
  ...
  addGround(){
    const textureLoader = new THREE.TextureLoader();
				...
				const texture = textureLoader.load( "../assets/disturb.jpg" );
  ...
  addSelf() {
    ...
    let _head = new THREE.Mesh(new THREE.SphereGeometry(1, 12, 12), videoMaterial);
